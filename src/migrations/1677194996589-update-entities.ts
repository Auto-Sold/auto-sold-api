...
export class updateEntities1677194996589 implements MigrationInterface {
    name = 'updateEntities1677194996589'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "completeName" character varying(225) NOT NULL, "email" character varying(100) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "telephone" character varying(15) NOT NULL, "password" character varying(100) NOT NULL, "cpf" integer NOT NULL, "image" character varying, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "vehicles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "announceType" character varying NOT NULL, "title" character varying(255) NOT NULL, "year" character varying NOT NULL, "km" integer NOT NULL, "price" numeric(10,2) NOT NULL, "description" text, "vehicleType" character varying NOT NULL, "image" character varying NOT NULL, "galeryImage1" character varying, "galeryImage2" character varying, "galeryImage3" character varying, "galeryImage4" character varying, "galeryImage5" character varying, "galeryImage6" character varying, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`);
